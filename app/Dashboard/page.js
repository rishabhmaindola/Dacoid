        ...
        <div className='flex flex-col w-full gap-3 items-center '>
            ...
            <div className='flex flex-col w-full p-2 gap-5 items-center justify-center'>
                <div className='flex w-full  p-5 shadow-lg rounded-xl bg-white items-center justify-between'>
                    ...
                    <div className="relative inline-block w-12 h-6 rounded-full bg-blue-400 p-1" onClick={toggleSwitch}>
                        <div className={`absolute left-0 w-5 h-5 rounded-full transition-transform duration-300 ease-in-out ${isOn ? 'bg-white transform translate-x-full' : 'bg-white'}`} />
                    </div>
                </div>
                <div className='flex w-full p-5 shadow-lg rounded-xl bg-white items-center justify-between'>
                    <span className='flex gap-2 '>
